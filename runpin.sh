...
pin -t /afs/pitt.edu/home/t/m/tmd62/private/pin/source/tools/ManualExamples/obj-intel64/pinatrace.so -- ./runcpu --config=try1 --action=run $FILE

cp pinatrace.out /afs/cs.pitt.edu/usr0/tmd62/public/memtraces/$FILE.mt
